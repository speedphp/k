...
module.exports = (handler_path, app) => {
    const server = http.createServer(app.callback())
    const io = socket(server)
    io.on('connection', (socket) => {
        let defaultHandlerPath = handler_path + '/handler.js'
        console.log(`isDefaultHandlerExists ${isDefaultHandlerExists}`)
        ...
        socket.onAny((event, ...args) => {
            ...
            let handlerClass = require(handler_path + '/' + handler_name + '.js')
